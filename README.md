...
- **Malyi, M., Shek, J., McDonald, A., & Biscaya, A. (2026). Wind Turbine Maintenance Log Labelling Framework: LLM-Driven Data Correction and Enrichment via Semantic Extraction of Reliability Intelligence.** <br> Preprint: [arXiv:2605.31281](https://arxiv.org/abs/2605.31281). <br> Related GitHub repo: [llm-driven-wind-turbine-maintenance-log-labelling](https://github.com/mvmalyi/llm-semantic-maintenance-logs-analysis)
